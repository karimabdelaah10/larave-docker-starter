                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="/dashboard_assets/images/login-v2.svg" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                >
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" id="login-email" type="text" name="email" placeholder="admin@example.com" aria-describedby="login-email" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="mb-1">
